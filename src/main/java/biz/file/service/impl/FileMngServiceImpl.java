...
import biz.file.dao.FileManageDAO;
...
public class FileMngServiceImpl implements FileMngService {
     ...
     * 여러 개의 파일을 삭제한다.
     *
     * @see FileMngService#deleteFileInfs(java.util.List)
     */
    @Override
     ...
     *
     * @see FileMngService#insertFileInfs(java.util.List)
     */
    @Override
     ...
     *
     * @see FileMngService#updateFileInfs(java.util.List)
     */
    @Override
