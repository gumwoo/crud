...
public class FileMngUtil {
	...
	public List<FileVO> parseFileInf(Map<String, MultipartFile> files, String KeyStr, int fileKeyParam, String atchFileId, String storePath) throws Exception {
		...
		while (itr.hasNext()) {
			...
			if (StringUtil.isEmpty(orginFileName)) {
				continue;
			}
	 ...
	 * @throws Exception
	 */
	public List<FileVO> parseFileInf(List<MultipartFile> files, String KeyStr, int fileKeyParam, String atchFileId, String storePath) throws FdlException, IOException {
		int fileKey = fileKeyParam;
